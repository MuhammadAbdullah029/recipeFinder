...
const RecipeCards = ({recipe, bg, badge}) => {
    const healthLabels = twovalues(recipe.healthLabels);
    ...
    <div className={`flex flex-col rounded-md ${bg} overflow-hidden p-3 relative`}>
                ...
                target="_blank"
                 className="relative h-60 md:h-32" >
                ...
                <div className="absolute right-2 top-2 bg-white rounded-full p-1 cursor-pointer "
                    onClick={(e) =>{
                        e.preventDefault();
